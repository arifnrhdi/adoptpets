...
const textQuotes = ["Your Pet's Home", "Your Pet's Need", "Your Friendly Platform", "The Best Choice"];
          ...
          <div className="flex container justify-between mx-auto items-center pl-6">
            ...
            <div className="flex items-center lg:gap-5 xl:gap-10">
              <a href="/" className="flex gap-2 items-center hover:text-slate-200">
                ...
                <h1 className="font-Sawa text-paleBlue text-xl font-bold text-white">AdoptPets</h1>
              </a>
            </div>
            ...
            <div className="flex items-center gap-4 p-4">
              <ul className="hidden lg:flex items-center gap-7 xl:gap-9">
                ...
                {isSearchOpen && (
                  <li>
                    <input type="text" className="rounded-lg xl:pr-32 p-1 md:pr-2 md:w-56" placeholder="Search" />
                  </li>
                )}
                <li>
              ...
              <div className="fixed inset-0 bg-slate-800 z-40 lg:hidden">
                <div className="flex flex-col items-center justify-center h-full px-5 relative">
                  ...
                  <div className="flex flex-col items-center gap-5">
                    ...
                    <a href="/" className="font-Sawa text-paleBlue text-3xl font-bold text-white mb-4">
                      AdoptPets
                    </a>
                  </div>
                  <input type="text" className="rounded-lg w-96 p-2 pl-2 pr-4 border border-slate-300 focus:ring-2 focus:ring-paleBlue" placeholder="Search in AdoptPets" />
                  <button className="w-1/2 text-center text-black bg-white rounded-md font-Sawa py-3 px-8 my-6">Search</button>

                  <button className="w-3/4 text-center text-black bg-white rounded-md font-Sawa py-3 px-8">Log Out</button>
                </div>
              </div>
            )}
          </div>
