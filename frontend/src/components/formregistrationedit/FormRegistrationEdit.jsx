...
function FormRegistrationEdit() {
  const navigate = useNavigate();
  function handleBackToProfile() {
    navigate("/user-profile"); // This will navigate to the profile page
  }
  function handleBackToHome() {
    navigate("/user-profile"); // This will navigate to the home page
  }
  ...
  const getAdoptById = async () => {
    try {
      ...
      setAnimalType(response.data.name);
    ...
    <>
      ...
      <section id="sec-login" className="flex flex-col md:flex-row items-center justify-center min-h-screen z-50 bg-slate-100 p-4 pb-12 pt-12">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 rounded-xl shadow-md w-full md:w-2/3 max-w-lg">
          <h1 className="text-4xl font-bold text-center">Edit Data Pet</h1>
          ...
          <div className="pet-info flex flex-col items-center">
            ...
            <div className="w-full mb-4">
              ...
              <input id="image" type="file" onChange={handleImageChange} className="w-full h-12 rounded-xl bg-gray-200 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            ...
            <p id="fgrtpass" className="mb-4 text-lg text-red-500">
              {msg}
            </p>
            ...
            <button type="submit" id="btnlgn" className="bg-slate-700 text-white w-32 h-12 rounded-2xl hover:bg-slate-800 mt-6 text-lg transition-transform duration-300">
              Save
            </button>
          </div>
...
export default FormRegistrationEdit;
