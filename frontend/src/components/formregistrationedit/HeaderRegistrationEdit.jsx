...
function HeaderRegistrationEdit() {
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
    const [isSearchOpen, setIsSearchOpen] = useState(false);
    
    // State untuk efek pengetikan
    const fullText = "Daftarkan Pets Hooman!🧸🕊️🐧";
                        ...
                        <div className="flex items-center gap-4 p-4">
                            ...
                            <ul className="hidden lg:flex items-center gap-7 xl:gap-9">
                                ...
                                <li>
                                    <a
                                        href="#"
                                        className="px-8 py-3 rounded-md bg-paleBlue font-medium text-white active:scale-90 transition duration-300 ease-in-out hover:bg-red-600 hover:text-slate-100 bg-slate-600"
                                    >
                                        Log Out
                                    </a>
                                </li>
...
export default HeaderRegistrationEdit;