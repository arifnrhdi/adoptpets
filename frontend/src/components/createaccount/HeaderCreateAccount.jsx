...
function HeaderCreateAccount() {
    ...
    // Fungsi untuk arahkan ke halaman login
    ...
    const fullText = "Ayo Buat Akunmu Hooman!🧸🕊️🐧";
    ...
    // Fungsi toggle untuk menu mobile
    const toggleMobileMenu = () => {
        setIsMobileMenuOpen(!isMobileMenuOpen);
    };

    // Fungsi toggle untuk pencarian
    const toggleSearch = () => {
    ...
    return (
        <>
            ...
            <header className="pb-24 nav__menu">
                <nav className="p-5 xl:px-7 w-full fixed z-50 transition-colors duration-300 ease-in-out bg-slate-800" id="navbar">
                    <div className="flex container justify-between mx-auto items-center pl-6">
                        ...
                        <div className="flex items-center lg:gap-5 xl:gap-10">
                            <a href="/" className="flex gap-2 items-center duration-300 hover:text-slate-200">
                                <img src={logoNavbar} alt="double-paw" className="w-14 duration-300 svg-icon text-white" draggable="false" />
                        ...
                        <div className="flex items-center gap-4 p-4">
                            ...
                            <ul className="hidden lg:flex items-center gap-7 xl:gap-9">
                                {/* Tombol Pencarian */}
                                <li>
                                    <button onClick={toggleSearch} className="cursor-pointer active:scale-90 transition duration-300 ease-in-out" aria-label="Search">
